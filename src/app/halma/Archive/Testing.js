const basicBoardSetupA = [
  ...
  },
  {
    ...
    neighbors: [119, 118],
    leftPixel: 176.47058823529412,
    topPixel: 523.5294117647059,
  },
];

for (const item of basicBoardSetupA) {
  item.topPixel -= 100;
}

basicBoardSetupA.forEach((item) => {
  console.log(item);
});
